...
import 'package:veritabani/model/model.dart';
...
class DBHelper{
  ...
  _createDatabase(Database db, int version) async{
    await db.execute(
      "CREATE TABLE mytodo(id INTEGER PRIMARY KEY AUTOINCREMENT,"
          " title TEXT NOT NULL, desc TEXT NOT NULL, dateandtime TEXT NOT NULL)",
    );
  }
  ...
  Future<int> uptade(TodoModel todoModel) async{
    var dbClient = await db;
